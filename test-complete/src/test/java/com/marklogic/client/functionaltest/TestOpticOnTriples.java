...
public class TestOpticOnTriples extends BasicJavaClientREST {
	...
	/* This test checks group by:
	 * 1) avg. Should return 4 results. Avg - 29
	 * 2) max. Should return 4 results. Max - 34
	 */
	@Test
	...
	/* This test checks group by:
	 * 1) Count. Should return 4 results. Returns Giants for Node 1 and for Node4 Athletics
	 * 2) Min on decimals. Should return 4 results. Min - 25.45
	 * 3) Sum on all.  Should return 1 result. Sum 350.4
	 */
	@Test
	...
	/*TEST 16 - join inner with array of graph iris
	 * Test options, p.sem.store() and p.sem.rulesetStore() 
	 */
	@Test
	...
	/* This test checks join inner outer with whereDistinct.
	 * Returns 8 results
	 */
	@Test
	...
	/* This test checks value processing functions.
	 * Returns 8 results
	 */
	@Test
	...
	/* This test checks export plan.
	 * Returns StringHandle instance with plan contents.
	 */
	@Test
