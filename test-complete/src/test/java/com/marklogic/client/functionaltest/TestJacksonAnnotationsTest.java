...
public class TestJacksonAnnotationsTest extends BasicJavaClientREST {
	...
	/*
	 * This method is used when there is a need to validate JsonPropertyCheck.
	 * Id field is not serialized and hence its default return value should be 0
	 */
	 ...
	 * Uses IgnoreProperties class which has @Id on the name methods. Test
	 * result expectations are: Java Default 0L is read back into the object.
	 */
	 ...
	 * 
	 * Test method testPOJOJsonIgnoreFields does a database store and then a
	 * read back and in that the Java Default 0 is read back into the object.
	 */
	@Test
	 ...
	 * expectations are: Java Default 0L is read back into the object.
	 * 
	 * Field id is not annotation. Its Getter/Setter are also not annotated.
	 * Hence that field is not serialized nor de-serialized.
	 */
	...
	/*
	 * Purpose : This test is to validate @JsonIgnore with valid POJO instance.
	 * Uses JsonPropertyCheck class which has @Id on the name methods. Test
	 * result expectations are: Mapper's write should not contain field - id.
	 * 
	 * Test method testPOJOJsonIgnoreFields does a database store and then a
	 * read back and in that the Java Default 0 is read back into the object.
	 */
