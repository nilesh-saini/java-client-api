 ...
 *
 */
public abstract class DmsdkConnectedRESTQA {
	 ...
	 *  @param dbName
	 */
	private static final Logger logger = LoggerFactory.getLogger(DmsdkConnectedRESTQA.class);
...
//							System.out.println("Adding child array include node" + jnode.toString());
	...
	public static void setupAppServicesConstraintAjit(String dbName) throws Exception {
